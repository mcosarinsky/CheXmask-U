...
def merge_df(df_img_path, df_lands_path):
    ...
    df_lands = pd.read_csv(df_lands_path, usecols=["image_id", "Landmark (Mean)"])
    df_lands.rename(columns={"image_id": "merge_key", "Landmark (Mean)": "landmarks"}, inplace=True)
...
if __name__ == '__main__':
    ...
    df_img_path = "/media/ngaggion/DATA/X-Ray/BigScale/Datasets/VinBigData/VinBigData_RCA.csv"
    df_lands_path = "/media/ngaggion/DATA/chexmask-database/Preprocessed/VinDr-CXR.csv"
    ...
    df_rca.to_csv("/media/ngaggion/DATA/chexmask-database/VinBigData_RCA.csv")    
