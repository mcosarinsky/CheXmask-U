...
def merge_df(df_img_path, df_lands_path):
    ...
    df_lands = pd.read_csv(df_lands_path, usecols=["Image Index", "Landmark (Mean)"])
    df_lands.rename(columns={"Image Index": "merge_key", "Landmark (Mean)": "landmarks"}, inplace=True)
...
if __name__ == '__main__':
    ...
    df_img_path = "/media/ngaggion/DATA/X-Ray/BigScale/Datasets/Chest8/CHEST8_RCA.csv"
    df_lands_path = "/media/ngaggion/DATA/chexmask-database/OriginalResolution/ChestX-Ray8.csv"
    ...
    df_rca.to_csv("/media/ngaggion/DATA/chexmask-database/ChestX-ray8_RCA.csv")
