...
def merge_df(df_img_path, df_lands_path):
    ...
    df_lands = pd.read_csv(df_lands_path, usecols=["dicom_id", "Mean"])
    df_lands.rename(columns={"dicom_id": "merge_key", "Mean": "landmarks"}, inplace=True)
...
if __name__ == '__main__':
    ...
    df_img_path = "/media/ngaggion/DATA/X-Ray/BigScale/Datasets/MIMIC/MIMIC_clean_RCA.csv"
    df_lands_path = "/media/ngaggion/DATA/chexmask-database/Preprocessed/MIMIC-CXR-JPG.csv"
    
    #df_merged = merge_df(df_img_path, df_lands_path)
    df_lands = pd.read_csv(df_lands_path, usecols=['Image', 'Landmark (Mean)', 'dicom_id'])
    ...
    df_rca.to_csv("/media/ngaggion/DATA/chexmask-database/MIMIC_RCA.csv")
